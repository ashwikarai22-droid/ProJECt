                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <b>Cat:</b> <?= $row['project_type'] ?>
                        </td>
                        <td><?= $row['leader_name'] ?><br><button class="btn btn-view">View Members</button></td>
                        <td><?= $row['leader_email'] ?><br><?= $row['leader_phone'] ?></td>
                        <td><button class="btn btn-view">View Submitted Idea</button></td>
                        <td>
                            <button class="btn btn-cyan">Freezed</button>
                            <a href="?delete_project=<?= $row['project_id'] ?>" class="btn btn-del" onclick="return confirm('Remove Project?')">Remove</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
